...
/// cppguide's
/// <a
/// href="https://drake.mit.edu/styleguide/cppguide.html#Static_and_Global_Variables">Static
...
///   static const common_utils::never_destroyed<std::vector<double>>
///   result{[]() {
...
class never_destroyed {
 public:
  COMMON_UTILS_NO_COPY_NO_MOVE_NO_ASSIGN(never_destroyed);
