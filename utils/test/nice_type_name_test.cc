...
GTEST_TEST(NiceTypeNameTest, Enum) {
  EXPECT_EQ(NiceTypeName::Get<Color>(), "common_utils::(anonymous)::Color");
  EXPECT_EQ(NiceTypeName::Get<ForTesting>(),
            "common_utils::(anonymous)::ForTesting");
  EXPECT_EQ(NiceTypeName::Get<ForTesting::MyEnum>(),
            "common_utils::(anonymous)::ForTesting::MyEnum");
  EXPECT_EQ(NiceTypeName::Get<ForTesting::MyEnumClass>(),
            "common_utils::(anonymous)::ForTesting::MyEnumClass");
...
GTEST_TEST(NiceTypeNameTest, FromTypeInfo) {
  ...
  EXPECT_EQ(NiceTypeName::Get(typeid(Derived)),
            "common_utils::(anonymous)::Derived");
}
...
GTEST_TEST(NiceTypeNameTest, Expressions) {
  ...
  EXPECT_EQ(NiceTypeName::Get(derived), "common_utils::(anonymous)::Derived");
  EXPECT_EQ(NiceTypeName::Get(*base), "common_utils::(anonymous)::Derived");
...
GTEST_TEST(NiceTypeNameTest, RemoveNamespaces) {
  ...
  EXPECT_EQ(
      NiceTypeName::RemoveNamespaces("common_utils::(anonymous)::Derived"),
      "Derived");
  ...
  EXPECT_EQ(NiceTypeName::RemoveNamespaces(
                "common_utils::systems::sensors::RgbdRenderer<T>::Impl"),
            "RgbdRenderer<T>::Impl");
...
GTEST_TEST(NiceTypeNameTest, Override) {
  ...
  EXPECT_EQ(NiceTypeName::Get<OverrideName>(),
            "common_utils::(anonymous)::OverrideName");
