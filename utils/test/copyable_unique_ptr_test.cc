...
#include "utils/test_utils/is_dynamic_castable.h"
#include "utils/unused.h"
#include <gtest/gtest.h>

/**
 * This file is copied from Drake's common/copyable_unique_ptr_test.cc
...
enum class Origin { UNINITIALIZED, CONSTRUCT, COPY, CLONE };
